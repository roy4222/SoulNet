...
function Footer() {
  return (
    ...
    <footer className="bg-gradient-to-r from-indigo-900 to-purple-900 text-white py-8 sm:py-10 lg:py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="text-center lg:text-left space-y-3">
            ...
            {/* 版權信息 */}
            <p className="text-xs sm:text-sm text-indigo-200 mt-4">
          ...
          <div className="text-center space-y-4">
            ...
            <ul className="space-y-3 sm:space-y-2">
              <li>
                <a 
                  href="/about" 
                  className="block sm:inline-block py-2 sm:py-1 text-indigo-200 hover:text-pink-300 transition duration-300"
                >
                  關於我們
                </a>
              </li>
          ...
          <div className="text-center lg:text-right space-y-4">
            ...
            <div className="flex justify-center lg:justify-end space-x-6 sm:space-x-4">
              ...
              <a 
                ...
                className="p-2 sm:p-1 text-indigo-200 hover:text-pink-300 transform hover:scale-110 transition duration-300"
              >
            ...
            {/* 製作信息，優化對齊方式 */}
            <div className="flex items-center justify-center lg:justify-end mt-6 text-sm text-indigo-200">
