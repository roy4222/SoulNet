                                    ...
                                    <AnimatePresence>
                                        {showDropdown && (
                                            ...
                                            >
                                                ...
                                                <Link 
                                                    to={ROUTES.PROFILE}
                                                    className="block px-4 py-2 text-sm text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900 transition-colors duration-200 flex items-center"
                                                ...
                                                {isAdmin() && (
                                                    <Link 
                                                        to={ROUTES.ADMIN}
                                                        className="block px-4 py-2 text-sm text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900 transition-colors duration-200 flex items-center"
                                                        onClick={() => setShowDropdown(false)}
                                                    >
                                                ...
                                                <Link 
                                                    ...
                                                    className="block px-4 py-2 text-sm text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900 transition-colors duration-200 flex items-center"
                                                    onClick={() => setShowDropdown(false)}
                                                >
                                                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" /></svg>
                                                    重設密碼
                                                </Link>
                                                {/* 登出按鈕 */}
                                                <button 
                                                    ...
                                                    className="block w-full text-left text-red-600 dark:text-red-500 hover:bg-gray-100 dark:hover:bg-gray-700 px-4 py-2 rounded-lg transition-colors duration-200 flex items-center"
                                                >
